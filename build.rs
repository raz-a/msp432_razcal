...
fn main() {
    ...
    let config_location = env!("RAZCAL_CONFIG", "RAZCAL_CONFIG environment variable not found");
...
fn get_supported_mcus() -> HashMap<String, Msp432Config> {
    ...
    // MSP432P401M family
    support_map.insert(String::from("msp432p401mipz"),
                       Msp432Config {
                           package: MSP432_PACKAGE_LQFP
                       });

    support_map.insert(String::from("msp432p401mipzr"),
                       Msp432Config {
                           package: MSP432_PACKAGE_LQFP
                       });

    support_map.insert(String::from("msp432p401mirgcr"),
                       Msp432Config {
                           package: MSP432_PACKAGE_VQFN
                       });

    support_map.insert(String::from("msp432p401mirgct"),
                       Msp432Config {
                           package: MSP432_PACKAGE_VQFN
                       });

    support_map.insert(String::from("msp432p401mizxhr"),
                       Msp432Config {
                           package: MSP432_PACKAGE_NFBGA
                       });

    support_map.insert(String::from("msp432p401mizxht"),
                       Msp432Config {
                           package: MSP432_PACKAGE_NFBGA
                       });

    // MSP432P401R family
    support_map.insert(String::from("msp432p401ripz"),
                       Msp432Config {
                           package: MSP432_PACKAGE_LQFP
                       });

    support_map.insert(String::from("msp432p401ripzr"),
                       Msp432Config {
                           package: MSP432_PACKAGE_LQFP
                       });

    support_map.insert(String::from("msp432p401rirgcr"),
                       Msp432Config {
                           package: MSP432_PACKAGE_VQFN
                       });

    support_map.insert(String::from("msp432p401rirgct"),
                       Msp432Config {
                           package: MSP432_PACKAGE_VQFN
                       });

    support_map.insert(String::from("msp432p401rizxhr"),
                       Msp432Config {
                           package: MSP432_PACKAGE_NFBGA
                       });

    support_map.insert(String::from("msp432p401rizxht"),
                       Msp432Config {
                           package: MSP432_PACKAGE_NFBGA
                       });
